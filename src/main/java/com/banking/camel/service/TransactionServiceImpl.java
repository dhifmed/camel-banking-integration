...
public class TransactionServiceImpl implements TransactionService {
    ...
    static {
        ...
        TransactionRecord r4 = new TransactionRecord("TXN004", "ACC132", "ACC465", 20000.0, "EUR", LocalDateTime.now());
    ...
    public TransactionHistoryResponse getTransactionHistory(String accountNumber) {
        ...
        for (TransactionRecord r : records) {
            if (r.getFromAccount().equals(accountNumber) || r.getToAccount().equals(accountNumber)) {
                history.add(r);
            }
        }
